...
Version  : 4.3.1
Release  : 13
URL      : https://github.com/intel/metee/archive/4.3.1/metee-4.3.1.tar.gz
Source0  : https://github.com/intel/metee/archive/4.3.1/metee-4.3.1.tar.gz
...
%prep
%setup -q -n metee-4.3.1
cd %{_builddir}/metee-4.3.1
pushd ..
cp -a metee-4.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738166566
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmetee.so.4.3.1
/usr/lib64/libmetee.so.4.3.1
