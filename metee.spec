...
Version  : 6.0.0
Release  : 15
URL      : https://github.com/intel/metee/archive/6.0.0/metee-6.0.0.tar.gz
Source0  : https://github.com/intel/metee/archive/6.0.0/metee-6.0.0.tar.gz
...
%prep
%setup -q -n metee-6.0.0
cd %{_builddir}/metee-6.0.0
pushd ..
cp -a metee-6.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750253993
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmetee.so.6.0.0.0
/usr/lib64/libmetee.so.6.0.0.0
