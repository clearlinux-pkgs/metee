...
Version  : 3.2.4
Release  : 7
URL      : https://github.com/intel/metee/archive/3.2.4/metee-3.2.4.tar.gz
Source0  : https://github.com/intel/metee/archive/3.2.4/metee-3.2.4.tar.gz
...
%prep
%setup -q -n metee-3.2.4
cd %{_builddir}/metee-3.2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702033170
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmetee.so.3.2.4
/usr/lib64/libmetee.so.3.2.4
