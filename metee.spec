...
Version  : 3.1.5
Release  : 4
URL      : https://github.com/intel/metee/archive/3.1.5/metee-3.1.5.tar.gz
Source0  : https://github.com/intel/metee/archive/3.1.5/metee-3.1.5.tar.gz
...
%prep
%setup -q -n metee-3.1.5
cd %{_builddir}/metee-3.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674079346
mkdir -p clr-build
pushd clr-build
