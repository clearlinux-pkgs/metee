...
Version  : 4.0.0
Release  : 8
URL      : https://github.com/intel/metee/archive/4.0.0/metee-4.0.0.tar.gz
Source0  : https://github.com/intel/metee/archive/4.0.0/metee-4.0.0.tar.gz
...
%prep
%setup -q -n metee-4.0.0
cd %{_builddir}/metee-4.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708965744
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmetee.so.4.0.0
/usr/lib64/libmetee.so.4.0.0
